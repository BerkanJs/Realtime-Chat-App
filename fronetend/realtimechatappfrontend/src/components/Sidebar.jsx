    ...
    <aside className="h-full w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
      ...
      <div className="overflow-y-auto w-full py-3">
        {filteredUsers.map((user) => (
          ...
          >
            <div className="relative flex-shrink-0 w-12 h-12 rounded-full overflow-hidden bg-base-200 flex items-center justify-center">
              {user.profilePic ? (
                <img
                  src={user.profilePic}
                  alt={user.fullName}
            ...
            <div className="hidden lg:block text-left min-w-[150px]">
